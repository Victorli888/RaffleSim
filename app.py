...
from model import get_active_buckets, compute_derived, compute_total_money, run_draw, run_multi_draw
...
def handle_run_multi_draw():
    n = max(1, min(1000, ss.get("multi_draw_n", 1)))
    ss.multi_draw = run_multi_draw(derived, ss.prize_num_prizes, buckets, n)
...
with left:
    render_left_panel(ss, derived, handle_run_draw, handle_run_multi_draw, buckets)
